...
def isValidWord(word, hand, wordList):
    ...
    """
    # TO DO ... <-- Remove this comment when you code this function
    word_in_dictionary = word in wordList
    word_in_hand = True
    new_hand = hand.copy()
    for letter in word:
        count = new_hand.get(letter, -1)
        new_hand[letter] = count - 1
        if new_hand[letter] < 0:
            word_in_hand = False

    return word_in_dictionary and word_in_hand
